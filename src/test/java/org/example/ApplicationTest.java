...
class ApplicationTest {
    ...
    void E2ETest() throws Exception {
        ...
        ArticleGetResponse checkArticleGetResponse = new ArticleGetResponse(testName, testNewTags.toString(), new ArrayList<>(List.of(testText)).toString(), false);
        ...
        checkArticleGetResponse = new ArticleGetResponse(testName, testNewTags.toString(), new ArrayList<>().toString(), false);
